...
const MovieCardVR = ({
  ...
  // Position poster on the left side, properly aligned
  const posterX = -cardWidth / 2 + posterWidth / 2 + 0.4;
  const posterY = cardHeight / 2 - posterHeight / 2 - 0.4;

  // Position text content with proper spacing
  ...
  return (
    ...
    >
      ...
      {/* Poster Group - Left side with proper styling */}
      ...
      <a-entity position={`${textX} 0 0.02`}>
        ...
        <a-entity position={`0 ${textStartY - 1.15} 0`}>
          ...
          {/* Metascore - positioned on same line, right of IMDb */}
          {isMovie && (
          ...
          {/* Rotten Tomatoes - positioned on same line, right of Metascore */}
          {isMovie && (
