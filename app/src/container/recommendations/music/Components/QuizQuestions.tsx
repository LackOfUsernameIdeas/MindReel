...
import { Genre, QuizQuestionProps } from "../musicRecommendations-types";
import {
  handleAnswerClick,
  handleInputChange,
  handleBack,
...
import { getMarginClass } from "@/container/helper_functions_common";
...
export const QuizQuestions: FC<QuizQuestionProps> = ({
  ...
  console.log("user's preferences: ", musicUserPreferences);
  return (
    <div>
      {showViewRecommendations && (
        <ViewRecommendations
      ...
      >
        <div
          className={`w-full max-w-4xl px-4 mb-[12rem] ${getMarginClass(
            currentQuestion
          )}`}
        >
