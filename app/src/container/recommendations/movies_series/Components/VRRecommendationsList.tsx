    ...
    >
      ...
      <a-entity>
        ...
        <a-plane
          ...
          position="0 0.01 0"
        ></a-plane>
        {/* Tiered platforms for each seat row */}
        {/* Row 1 platform - z: 2 */}
        <a-box
          position="0 0.025 2"
          width="10"
        ...
        <a-plane
          ...
          position="0 0.551 12"
        ></a-plane>
        {/* Aisle carpet runners - left and right */}
        <a-plane
          rotation="-90 0 0"
          width="1.8"
          height="14"
        ...
        <a-plane
          ...
          position="6 0.02 6"
        ></a-plane>
        {/* Subtle aisle edge lighting strips */}
        <a-box
          position="-5.1 0.03 6"
          width="0.08"
          height="0.02"
